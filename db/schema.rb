...
ActiveRecord::Schema[7.0].define(version: 2024_10_04_083353) do
  create_table "pomodoro_tasks", force: :cascade do |t|
    ...
    t.index ["task_id"], name: "index_pomodoro_tasks_on_task_id"
  end
  ...
  add_foreign_key "pomodoro_tasks", "pomodoros"
  add_foreign_key "pomodoro_tasks", "tasks"
